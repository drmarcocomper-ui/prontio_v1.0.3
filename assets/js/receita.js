...
// Tela de receita do paciente
// Usa o ID_Paciente salvo no localStorage (prontio_pacienteAtualId)
// Ações de API usadas:
// - Receita.Criar
...
/**
 * Exibe mensagem usando o padrão do layout (classes .mensagem-*)
 */
function mostrarMensagemReceita(texto, tipo = "info") {
  const div = document.getElementById("mensagemReceita");
  if (!div) return;
